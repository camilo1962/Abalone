...
public class Abalone : MonoBehaviour
{
  ...
  public void generateBoard()
  {
    ...
    // Tome el estado del juego desde el backEnd y empújelo hacia el front-end.
    //Utilizar para cada cambio de estado.
    public void updateUIBoard()
  {
    ...
    //Tomar el estado del juego desde el front-end y empujarlo hacia el back-end
    //INNEFICIENTE. Úselo únicamente para la creación inicial de la Junta.
  ...
  {
    Node nodeToReturn = new Node("NODO DE ENCUENTRO DE ERROR", BoardColor.EMPTY, true, 0, 0);
