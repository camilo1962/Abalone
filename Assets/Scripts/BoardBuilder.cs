...
public class BoardBuilder : MonoBehaviour
{
  ...
  public static Node[,] createBoard()
  {
   ...
   //Función de referencia rápida para comprobar si estamos en coordenadas nulas para la generación del tablero de juego
    public static bool checkIfNullCoordinates(int i, int j)
  {
   ...
   //Generar todos los nodos vecinos para cada Nodo.
