...
public class Agent : MonoBehaviour
{
  ...
  public State turn(State startState)
  {
    ...
    else
    {
      ...
      {
        consoleManager.sendMessageToConsole("Usando el primer estado al azar.");
        consoleManager.sendMessageToConsole("Combinaciones marcadas " + numberOfCombinationsChecked);
        return currentState.getNextStates()[0];
      }
      consoleManager.sendMessageToConsole("Combinaciones marcadas " + numberOfCombinationsChecked);
      consoleManager.sendMessageToConsole("Combinaciones marcadas" + bestMove.getValue());
      return bestMove;
    }
